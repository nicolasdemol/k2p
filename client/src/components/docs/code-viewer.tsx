  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button variant="secondary">Extraire le code</Button>
      </DialogTrigger>
          ...
          <div className="rounded-md bg-black text-white p-6">
            <pre>
              <code className="grid gap-1 text-sm text-muted-foreground [&_span]:h-4">
                ...
                <span>
                  {" "}
                  prompt=<span className="text-yellow-300">&quot;&quot;</span>,
                </span>
                <span>
                  {" "}
                  temperature=<span className="text-yellow-300">0.9</span>,
                </span>
                <span>
                  {" "}
                  max_tokens=<span className="text-yellow-300">5</span>,
                </span>
                <span>
                  {" "}
                  top_p=<span className="text-yellow-300">1</span>,
                </span>
                <span>
                  {" "}
                  frequency_penalty=<span className="text-yellow-300">0</span>,
                </span>
                <span>
                  {" "}
