...
import ButtonGroup from "../annotator/ButtonGroup";
import { toast } from "../ui/use-toast";
import { CardDocEntities } from "./card-doc-entities";
...
export const CardDocViewer = ({
  ...
  const [annotations, setAnnotations] =
    React.useState<Annotation[]>(defaultAnnotations);
    ...
    if (doc && doc.name) {
      ...
      api
        ...
        .catch((err) => {
          toast({
            variant: "destructive",
            title: "Impossible d'importer ce fichier.",
            description:
